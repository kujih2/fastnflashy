...
$(function(){
	$('.content-main').hide();
	$('#normal_mem').click(function(){
		$('.content-main').show();
		$('#choice').hide();
		$('#auth1').prop('checked',true);
		$('#auth2').prop('disabled',true);
	});
	$('#col_mem').click(function(){
		$('.content-main').show();
		$('#choice').hide();
		$('#auth2').prop('checked',true);
		$('#auth1').prop('disabled',true);
	});
	...
	<div class="content-main">
		...
		<form id="register_form" action="registerUser.do" method="post">
			...
			<ul>
				<li>
					<label>회원분류</label>
					<input type="radio" name="auth" id="auth1" value="1" >일반회원
					<input type="radio" name="auth" id="auth2" value="2" >칼럼리스트회원
				</li>
				<li>
